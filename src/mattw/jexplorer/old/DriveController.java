...
import mattw.jexplorer.old.io.FilesTransferrable;
...
public class DriveController extends StackPane {
    static final Image FILE_ICON = new Image(DriveExplorer.FileWrapper.class.getResource("/mattw/jexplorer/old/img/file.png").toExternalForm());
    private static final Image FOLDER_ICON = new Image(DriveExplorer.FileWrapper.class.getResource("/mattw/jexplorer/old/img/folder.png").toExternalForm());
    ...
    private static class DriveExplorer extends TabPane {
        private final Image BACK_ICON = new Image(getClass().getResource("/mattw/jexplorer/old/img/back.png").toExternalForm());
        private final Image HOME_ICON = new Image(getClass().getResource("/mattw/jexplorer/old/img/home.png").toExternalForm());
        private final Image RELOAD_ICON = new Image(getClass().getResource("/mattw/jexplorer/old/img/reload.png").toExternalForm());
