...
public class DriveView extends HBox {
    ...
    public DriveView(Drive drive) {
        ...
        if(drive.getType() == Type.LOCAL || drive.getType() == Type.LOCAL_SMB) {
            ...
            Image SMB_ICON = new Image(getClass().getResource("/mattw/jexplorer/old/img/samba.png").toExternalForm());
            ...
            Image FTP_ICON = new Image(getClass().getResource("/mattw/jexplorer/old/img/ftp.png").toExternalForm());
